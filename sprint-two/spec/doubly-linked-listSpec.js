describe('doublyLinkedList', function() {
  ...
  it('should have methods named "addToTail", "removeHead", and "contains", "addToHead" and "removeTail', function() {
  ...
  it('should not contain a value that was not added', function() {
    expect(linkedList.contains(50)).to.equal(false);
  });

  it('should have nodes that have next and previous properties', function() {
    var node = Node();
